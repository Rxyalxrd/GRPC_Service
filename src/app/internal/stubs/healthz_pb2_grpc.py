...
from . import healthz_pb2 as healthz__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in healthz_pb2_grpc.py depends on'
...
def add_StatusServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Healthz': grpc.unary_unary_rpc_method_handler(
                    servicer.Healthz,
                    request_deserializer=healthz__pb2.HealthzRequest.FromString,
                    response_serializer=healthz__pb2.HealthzResponse.SerializeToString,
            ),
    }
